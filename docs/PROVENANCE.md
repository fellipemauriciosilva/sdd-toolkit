...
| `.github/workflows/` | Automação do projeto | Actions fixadas e inventariadas em `THIRD_PARTY_NOTICES.md` |
...
- O inventário de componentes distribuídos e de CI deve permanecer sincronizado
  com `THIRD_PARTY_NOTICES.md`.
