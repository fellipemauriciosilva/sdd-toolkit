...
name: doc-reader
description: >
  Skill para ler, extrair e interpretar conteúdo de arquivos Microsoft Word
  (.doc e .docx) presentes no workspace (especificações, contratos,
  documentos de negócio, RFCs, manuais operacionais) e transformá-lo em
  contexto utilizável pelo Copilot durante tarefas de análise, criação de
  specs, geração de testes e implementação.
applyTo: "**/*.{doc,docx}"
triggers:
  - "ler doc"
  - "ler docx"
